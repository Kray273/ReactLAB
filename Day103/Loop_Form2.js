...
class UserInform extends React.Component{
    ...
    addUserHandler=()=>{
        ...
        this.props.addUser
        ({id:this.state.id , pw:this.state.pw, name : this.state.name, 
            age : this.state.age});
    }

    render(){
        return (<div>
            <h1>아이디입력<input type="text" id="id" name="id"
            placeholder="아이디 입력" onChange={this.changeHandler} /> </h1>
            <h1>암호입력<input type="password" id="pw" name="pw"
            placeholder="암호 입력" onChange={this.changeHandler} /> </h1>
            <h1>이름입력<input type="text" id="name" name="name"
            placeholder="이름 입력" onChange={this.changeHandler} /> </h1>
            <h1>나이입력<input type="text" id="age" name="age"
            placeholder="나이 입력" onChange={this.changeHandler} /> </h1>
